package datastructures.stacks.witharray;
...
public class Stack<T> {
    ...
    // we have to add the new item to the end of the array O(1)
    public void push(T newData) {
        // arrays are not dynamic data structures!!
        // we have to resize the underlying array if necessary
        // if there are too many items in the array: we double the size of the array
        // if there are few item: then we decrease (shrink) the array
